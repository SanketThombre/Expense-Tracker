export const dashboardStyles = {
  ...
  // Header styles
  headerContainer:
    "bg-gradient-to-r from-teal-500/10 to-cyan-500/10 backdrop-blur-lg rounded-3xl p-6 mb-8 shadow-lg border border-white/30 dark:border-gray-800",

  headerContent:
    "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8",

  headerTitle:
    "text-3xl md:text-4xl font-bold bg-gradient-to-r from-teal-600 to-cyan-700 bg-clip-text text-transparent",

  headerSubtitle: "text-gray-600 dark:text-gray-400 mt-2",

  // Button styles
  addButton:
    "flex items-center gap-2 bg-teal-500 hover:bg-teal-600 text-white px-5 py-3 rounded-xl transition-all shadow hover:shadow-md font-medium",

  // Time frame selector styles
  timeFrameContainer: "flex justify-end mt-4",

  timeFrameWrapper:
    "flex gap-0 bg-white dark:bg-gray-900 p-1 -mx-5 rounded-xl border border-gray-200 dark:border-gray-700",
  ...
  // Summary cards grid
  summaryGrid:
    "grid grid-cols-1 lg:-mx-3 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-5 mb-8",

  // Financial card styles
  balanceBadge:
    "bg-teal-100 dark:bg-teal-900/30 text-teal-800 dark:text-teal-300 px-2 py-1 rounded-lg text-xs",

  expenseBadge:
    "bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-300 px-1 py-1 rounded-lg text-xs",

  // Gauge container styles
  gaugeGrid:
    "grid grid-cols-1 -mx-5 xl:-mx-5 md:grid-cols-3 md:gap-13 lg:gap-3 lg:grid-cols-2 xl:grid-cols-3 gap-6 mb-8",

  // Pie chart container styles
  pieChartContainer:
    "hidden md:block bg-white dark:bg-gray-900 lg:-mx-5.5 md:-mx-4 lg:p-1 xl:-mx-3 rounded-xl p-5 shadow-sm border border-gray-100 dark:border-gray-800 relative overflow-hidden mb-8",

  pieChartHeader:
    "flex flex-col sm:flex-row justify-between items-start sm:items-center mb-5 gap-3",

  pieChartTitle:
    "text-xl lg:pt-3 xl:pl-3 font-bold text-gray-800 dark:text-white mb-5 flex items-center gap-3",

  pieChartSubtitle:
    "text-sm lg:text-center xl:text-start xl:pl-3 text-gray-500 dark:text-gray-400 mb-3",
  ...
  legendText: "text-sm font-medium text-gray-600 dark:text-gray-400",
  ...
  listContainer:
    "bg-white dark:bg-gray-900 rounded-2xl lg:p-5 md:p-6 -mx-8 md:-mx-3 shadow-sm border border-gray-100 dark:border-gray-800",

  listHeader:
    "flex flex-col sm:flex-row justify-between items-start sm:items-center mb-5 gap-3",

  listTitle:
    "text-xl font-bold text-gray-800 dark:text-white md:mt-3 mt-3 flex items-center gap-3",

  listSubtitle: "text-sm text-gray-500 dark:text-gray-400 font-normal",

  // Record count badges
  incomeCountBadge:
    "text-sm bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 px-2 mx-2 md:mx-2 md:mt-2 py-1 rounded-full",

  expenseCountBadge:
    "text-sm bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-300 px-2 mx-2 md:mx-2 md:mt-2 py-1 rounded-full",

  // Transaction item styles
  transactionList: "space-y-3",

  incomeTransactionItem:
    "flex items-center px-2 mx-2 my-2 md:p-4 md:mx-2 lg:px-3 justify-between p-3 bg-green-50 dark:bg-green-900/20 rounded-lg",

  expenseTransactionItem:
    "flex items-center justify-between mx-1 p-3 lg:p-3 md:p-4 md:mx-2 bg-orange-50 dark:bg-orange-900/20 rounded-lg",

  // Transaction icon container
  incomeIconContainer: "p-2 bg-green-100 dark:bg-green-900/30 rounded-lg",

  expenseIconContainer: "p-2 bg-orange-100 dark:bg-orange-900/30 rounded-lg",

  // Transaction content
  transactionContent: "flex items-center lg:gap-3 md:gap-3 gap-1",

  transactionDescription: "font-medium text-gray-800 dark:text-white",

  transactionCategory: "text-sm text-gray-500 dark:text-gray-400",

  transactionAmount: "text-right",

  incomeAmount: "font-bold text-green-600 dark:text-green-400",

  expenseAmount: "font-bold text-orange-600 dark:text-orange-400",
  ...
  emptyIconContainer: (color) =>
    `w-16 h-16 mx-auto mb-4 rounded-full ${color} flex items-center justify-center`,

  emptyText: "text-gray-600 dark:text-gray-400 font-medium",

  // View all button styles
  viewAllContainer: "pt-4 border-t border-gray-100 dark:border-gray-800",

  viewAllButton:
    "w-full flex items-center justify-center gap-2 py-3 text-teal-600 dark:text-teal-400 font-medium hover:bg-teal-50 dark:hover:bg-teal-900/20 rounded-xl transition-colors",

  // Icon container styles
  iconContainer: (color) => `p-2 ${color} rounded-lg`,

  // Specific icon colors
  walletIconContainer: "p-2 bg-teal-100 dark:bg-teal-900/30 rounded-lg",

  arrowDownIconContainer: "p-2 bg-orange-100 dark:bg-orange-900/30 rounded-lg",

  piggyBankIconContainer: "p-2 bg-cyan-100 dark:bg-cyan-900/30 rounded-lg",
};

// Additional styles for financial trends

export const trendStyles = {
  positive: "text-orange-500",
  negative: "text-green-500",
  positiveRate:
    "bg-teal-100 dark:bg-teal-900/30 text-teal-700 dark:text-teal-300",
  negativeRate: "bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300",
};
...
export const incomeStyles = {
  ...
  viewAllButton:
    "mt-4 w-full text-center py-3 text-green-600 font-medium hover:bg-green-50 rounded-xl transition-colors flex items-center justify-center gap-2",
...
export const expensePageStyles = {
  ...
  cardsGrid:
    "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-5",
  ...
  viewAllButton:
    "mt-4 w-full text-center py-3 text-orange-600 font-medium hover:bg-amber-50 rounded-xl transition-colors flex items-center justify-center gap-2",
  emptyState: "text-center py-8",
  emptyStateIcon:
    "w-16 h-16 mx-auto mb-4 rounded-full bg-orange-50 flex items-center justify-center",
  ...
  transactionItemContainer:
    "flex items-center justify-between p-3 -mx-2 hover:bg-amber-50 rounded-xl transition-all duration-300 border border-gray-100 cursor-pointer mb-3 group",
...
export const profileStyles = {
  ...
  avatar:
    "w-24 h-24 mx-auto rounded-full bg-white/20 flex items-center justify-center mb-4",
...
export const modalStyles = {
  ...
  input: (ringColor) =>
    `w-full border border-gray-200 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 ${ringColor}`,
...
export const loginStyles = {
  // Page container
  pageContainer:
    "min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-teal-50 to-emerald-50",
  ...
  avatar:
    "w-20 h-20 mx-auto rounded-full bg-white/20 flex items-center justify-center mb-4",
  ...
  // Error message
  errorContainer:
    "mb-6 p-3 bg-red-50 text-red-700 rounded-lg flex items-center",
  errorIcon:
    "w-6 h-6 rounded-full bg-red-100 flex items-center justify-center mr-3",
  ...
  // Button
  button:
    "w-full bg-gradient-to-r from-teal-500 to-emerald-600 text-white py-3 rounded-xl font-medium shadow-md hover:shadow-lg transition-all flex items-center justify-center",
...
//   container:
//     "flex items-center justify-between px-4 py-3 md:px-8 max-w-7xl mx-auto dark:bg-gray-900 dark:text-white",
...
//   // Text styles
//   logoText:
//     "lg:text-3xl md:text-3xl text-2xl text-gray-900 font-[550] lobster-regular dark:text-white",

//   // User profile styles
//   userContainer: "relative",
//   userButton:
//     "flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors",
//   userAvatar:
...
//   chevronIcon: (isOpen) =>
//     `w-4 h-4 text-gray-500 transition-transform ${isOpen ? "rotate-180" : ""}`,
...
export const navbarStyles = {
  // Layout and container styles
  header:
    "sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm dark:bg-gray-900 dark:border-gray-800",
  ...
  // Text styles
  logoText:
    "lg:text-3xl md:text-3xl text-2xl font-[550] lobster-regular text-gray-900 dark:text-white",
  ...
  statusIndicator:
    "absolute -bottom-1 -right-1 w-3 h-3 bg-green-500 rounded-full border-2 border-white dark:border-gray-900",

  userTextContainer: "text-left hidden md:block",

  userName:
    "text-sm font-medium text-gray-800 dark:text-gray-100 truncate max-w-[120px]",

  userEmail: "text-xs text-gray-500 dark:text-gray-400 truncate max-w-[120px]",
  ...
  // Dropdown menu styles
  dropdownMenu:
    "absolute top-14 right-0 w-56 bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-100 dark:border-gray-800 z-50",

  dropdownHeader: "px-4 py-3 border-b border-gray-100 dark:border-gray-800",
  ...
  menuItem:
    "w-full px-4 py-3 text-left hover:bg-gray-50 dark:hover:bg-gray-800 text-sm text-gray-700 dark:text-gray-200 flex items-center gap-3 rounded-lg",

  menuItemBorder: "p-1.5 border-t border-gray-100 dark:border-gray-800",

  logoutButton:
    "flex w-full items-center gap-3 px-4 py-3 text-sm hover:bg-red-50 dark:hover:bg-red-950/40 text-red-600 dark:text-red-400 rounded-lg",
};
...
export const signupStyles = {
  ...
  header:
    "bg-gradient-to-r from-teal-500 to-emerald-600 p-6 text-center relative",
  avatar:
    "w-20 h-20 mx-auto rounded-full bg-white/20 flex items-center justify-center mb-4",
  headerTitle: "text-2xl font-bold text-white",
  headerSubtitle: "text-teal-100 mt-2",
  backButton:
    "absolute top-4 left-4 p-2 text-white rounded-full hover:bg-white/10 transition-colors",
...
export const transactionItemStyles = {
  ...
  input: (hasError, classes) =>
    `w-full bg-white rounded-lg px-3 py-2 focus:outline-none focus:ring-1 ${
      hasError
        ? "border-red-500 ring-red-500"
        : `${classes.border} ${classes.ring}`
    }`,
  amountInput: (hasError, classes) =>
    `w-full max-w-[120px] bg-white rounded-lg px-3 py-2 focus:outline-none focus:ring-1 ${
      hasError
        ? "border-red-500 ring-red-500"
        : `${classes.border} ${classes.ring}`
    }`,
  ...
  deleteButton: (classes) =>
    `p-2 ${classes.text} rounded-lg hover:${classes.bg}`,
};
...
export const sidebarStyles = {
  ...
  sidebarInner: {
    base: "bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 shadow-md h-full flex flex-col",
  },

  // User profile section
  userProfileContainer: {
    base: "p-4 border-b pt-20 md:pt-5 lg:pt-5 xl:pt-5 border-gray-100 dark:border-gray-800",
    collapsed: "px-3",
    expanded: "px-6",
  },
  ...
  menuItem: {
    ...
    inactive:
      "text-gray-600 dark:text-gray-300 hover:text-teal-700 dark:hover:text-teal-400 hover:bg-gray-50 dark:hover:bg-gray-800",
  ...
  // Toggle button
  toggleButton: {
    base: "absolute -right-3 top-12 z-20 w-6 h-6 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-full flex items-center justify-center text-gray-500 dark:text-gray-300 hover:text-teal-600 dark:hover:text-teal-400 hover:border-teal-400 hover:bg-teal-50 dark:hover:bg-gray-700 transition-all",
  },

  // Footer section
  footerContainer: {
    base: "border-t border-gray-100 dark:border-gray-800 p-4",
    collapsed: "px-3",
    expanded: "px-6",
  },

  footerLink: {
    base: "flex items-center gap-3 py-2 rounded-xl font-medium text-gray-600 dark:text-gray-300 hover:text-teal-700 dark:hover:text-teal-400 hover:bg-gray-50 dark:hover:bg-gray-800",
    collapsed: "justify-center",
  },

  logoutButton: {
    base: "flex items-center gap-3 py-2 rounded-xl font-medium text-gray-600 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 w-full mt-1",
    collapsed: "justify-center",
  },
  ...
  mobileBackdrop:
    "absolute inset-0 bg-black/30 dark:bg-black/60 backdrop-blur-sm",

  mobileSidebar: {
    base: "absolute left-0 top-0 bottom-0 w-4/5 max-w-sm bg-white dark:bg-gray-900 shadow-2xl rounded-r-2xl overflow-hidden",
  },

  mobileHeader:
    "p-6 flex justify-between items-center border-b border-gray-100 dark:border-gray-800",
  ...
  mobileFooter: "border-t border-gray-100 dark:border-gray-800 p-6",

  mobileFooterLink:
    "flex items-center gap-4 py-2 font-medium text-gray-600 dark:text-gray-300 hover:text-teal-700 dark:hover:text-teal-400",

  mobileLogoutButton:
    "flex items-center gap-4 py-2 font-medium text-gray-600 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400 w-full",
...
//       `p-4 pt-6 transition-all duration-300 ${
...
//     cardTitle:
//       "text-md md:text-xl lg:text-xl xl:text-xl font-bold text-gray-800 flex items-center gap-3",
//     refreshButton: "p-2 rounded-lg hover:bg-gray-100 transition-colors",
//     refreshIcon: (loading) =>
//       `w-5 h-5 text-gray-500 ${loading ? "animate-spin" : ""}`,
//     dataStackingInfo:
//       "flex items-center gap-2 text-xs text-gray-500 mb-4 bg-blue-50 p-2 rounded-lg",
//     dataStackingIcon: "w-4 h-4 text-blue-500",
//     listContainer: "space-y-4 max-h-[500px] -mx-5 overflow-y-auto pr-2",
//     transactionItem:
//       "flex items-center lg:flex-col xl:flex-row md:flex-row justify-between p-1 -mx-0 lg:p-4 md:p-4 hover:bg-gray-50 rounded-xl transition-all duration-300 border border-gray-100",
//     iconWrapper: (type) =>
//       type === "income"
...
//     amount: (type) =>
//       `font-semibold ${
//         type === "income" ? "text-teal-600" : "text-orange-600"
//       }`,
//     emptyState: "text-center py-8",
//     emptyIconContainer:
...
//     viewAllButton:
//       "w-full flex items-center justify-center gap-2 py-3 text-teal-600 font-medium hover:bg-teal-50 rounded-xl transition-colors",
//   },

//   // Spending by Category Card
//   categories: {
//     title:
//       "text-lg md:text-xl lg:text-xl xl:text-xl font-bold text-gray-800 mb-6 flex items-center gap-3",
//     titleIcon: "w-6 h-6 text-cyan-500",
//     list: "space-y-4",
//     categoryItem:
//       "flex items-center md:text-lg lg:text-sm xl:text-lg justify-between",
...
//     summaryIncomeCard:
//       "bg-gradient-to-br from-teal-50 to-cyan-50 rounded-xl p-4",
//     summaryExpenseCard:
//       "bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-4",
...
export const styles = {
  ...
  statCards: {
    ...
    card: "bg-white dark:bg-gray-900 p-5 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800",

    cardHeader: "flex justify-between items-start",

    cardTitle: "text-sm text-gray-600 dark:text-gray-400",

    cardValue: "text-2xl font-bold text-gray-800 dark:text-white mt-1",

    iconContainer: (color) =>
      `bg-${color}-100 dark:bg-${color}-900/30 p-2 rounded-lg`,

    icon: (color) => `w-5 h-5 text-${color}-600 dark:text-${color}-400`,

    cardFooter: "text-xs text-gray-500 dark:text-gray-400 mt-3",
  },
  ...
  // Card Styles
  cards: {
    base: "bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-800",
    header: "flex justify-between items-center mb-6",
    title:
      "text-xl font-bold text-gray-800 dark:text-white flex items-center gap-3",
    titleIcon: "w-6 h-6",
  },
  ...
  transactions: {
    cardHeader: "flex justify-between items-center mb-4",
    cardTitle:
      "text-md md:text-xl lg:text-xl xl:text-xl font-bold text-gray-800 dark:text-white flex items-center gap-3",
    ...
    dataStackingInfo:
      "flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400 mb-4 bg-blue-50 dark:bg-blue-900/20 p-2 rounded-lg",

    transactionItem:
      "flex items-center lg:flex-col xl:flex-row md:flex-row justify-between p-1 -mx-0 lg:p-4 md:p-4 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-xl transition-all duration-300 border border-gray-100 dark:border-gray-800",
    ...
    description:
      "font-medium text-gray-800 dark:text-white truncate max-w-[120px]",

    meta: "text-xs text-gray-500 dark:text-gray-400 mt-1",
    ...
    emptyIconContainer:
      "w-16 h-16 mx-auto mb-4 rounded-full bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center",

    emptyIcon: "w-8 h-8 text-purple-500 dark:text-purple-400",
  ...
  categories: {
    title:
      "text-lg md:text-xl lg:text-xl xl:text-xl font-bold text-gray-800 dark:text-white mb-6 flex items-center gap-3",

    titleIcon: "w-6 h-6 text-cyan-500 dark:text-cyan-400",
    ...
    categoryIconContainer:
      "bg-gray-100 dark:bg-gray-800 dark:text-gray-400 p-2 rounded-lg",

    categoryIcon: "w-4 h-4 text-gray-600 dark:text-gray-400",

    categoryName: "font-medium text-gray-700 dark:text-gray-300",

    categoryAmount: "font-semibold text-gray-800 dark:text-gray-300",

    summaryContainer: "mt-6 pt-6 border-t border-gray-100 dark:border-gray-800",

    summaryGrid: "grid grid-cols-2 gap-4",

    summaryIncomeCard:
      "bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-900/20 dark:to-cyan-900/20 rounded-xl p-4",

    summaryExpenseCard:
      "bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 rounded-xl p-4",

    summaryTitle: "text-sm text-gray-600 dark:text-gray-400",

    summaryValue: "text-sm font-bold text-gray-800 dark:text-white",
  },
